...
inline esp_err_t i2c_dev_readmulti_reg(const i2c_dev_t *dev, uint8_t reg1,uint8_t reg2,uint8_t reg3,void *in_data1, void *in_data2, void *in_data3, size_t in_size)
{
    return i2c_dev_readmulti(dev, &reg1, &reg2, &reg3, 1, in_data1, in_data2, in_data3, in_size);
}
